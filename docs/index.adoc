...
+
[source,haskell]
.src/math/factorial/fac.hs
----
include::../src/math/factorial/fac.hs[]
----
+
[source,haskell]
----
...
----
include::../src/math/collatz-with-guards.hs[]
----
+
[source,haskell]
.src/math/collatz_with-pat.hs
----
include::../src/math/collatz_with-pat.hs[]
----
...
[source,console]
----
$ ghci src/math/collatz-with-guards.hs
----
+
[source,haskell]
----
