...
[source,haskell]
----
*Main> :load src/flow-control/loop_counter_no_guards.hs
[1 of 1] Compiling Main             ( src/flow-control/loop_counter_no_guards.hs, interpreted )
...
[source,haskell]
----
*Main> :load src/flow-control/loop_counter_using_guards.hs
[1 of 1] Compiling Main             ( src/flow-control/loop_counter_using_guards.hs, interpreted )
Ok, modules loaded: Main.
*Main> main
1
2
